...
describe('Quantity Calculator', () => {
    ...
    describe('Test 2: Inv= fix, Case = DoNothing, Min = fix', ()=>{
        ...
        describe ('CASE 5:  case = 0. inv = 3,factor = 1, min = 2', () => {
            ...
            let calc = new QuantityCalculator(config,inventory,caseBehavior,minBehavior,invBehavior);
            describe ('1: inc tests:', () => {
                it('get cq should return 0', () => {
                    return calc.getCq();
                }) 
                it('1: inc should go to 2', inc(2,calc,0));
            });
            describe ('2: dec tests:', () => {
                it('1: dec should stay 2', dec(2,calc,2));
            });
            describe ('3: set tests:', () => {
                it('1: set to 0 should be 0', set(0,calc,0));
    ...
    describe('Test 5: factor = 0 all fix', ()=>{
        ...
        describe ('CASE 1: factor = 0 inv = 8 case = 2 min = 3', () => {
            ...
            describe ('1: inc tests:', () => {
                ...
                it('2: inc should go up from 4 to 6', inc(6,calc,4));
                it('3: inc should go up from 6 to 8', inc(8,calc,6));
                it('4: inc should go to 10', inc(10,calc,8));
                it('5: inc should go to 12', inc(12,calc,10));
            });
            describe ('2: dec tests:', () => {
                it('1: dec should go down from 12 to 10', dec(10,calc,12));
                it('2: dec should go down from 10 to 8', dec(8,calc,10));
                it('3: dec should go down from 8 to 6', dec(6,calc,8));
                it('4: dec should go down from 6 to 4', dec(4,calc,6));
                it('5: dec should go down from 4 to 0', dec(0,calc,4));
                it('6: dec should stay 0', dec(0,calc,0));
            });
    ...
    describe('Test 11: Inv= fix, Case = fix, Min = fix', ()=>{
        ...
        describe ('CASE 1: default inc,dec,set with inv = 10 case = -5 factor = 1, min = 0', () => {
            let  config: UomItemConfiguration = {'UOMKey': "", 'Case':-5, 'Min': 0, 'Factor':1, 'Negative': true};
            let inventory: number = 10;
            let calc = new QuantityCalculator(config,inventory,caseBehavior,minBehavior,invBehavior);
            describe ('1: inc tests:', () => {
                it('get cq should return -5 ', ()=> {
                    expect(calc.getCq()).that.is.eql(-5);
                })
                it('1: inc should stay 0', inc(0,calc,0));
            });
            describe ('2: dec tests:', () => {
                it('1: dec should go to 5', dec(5,calc,0));
                it('2: dec should go from 5 to 10', dec(10,calc,5));
            });
            describe ('3: set tests:', () => {
                it('1: set to 0', set(0,calc,0));
                it('2: set to 10', set(10,calc,10));
            ...
            describe ('4: set inc dec cobination:', () => {
                it('1: set to 0', set(0,calc,0));
                it('2: inc should stay 0', inc(0,calc,0));
                it('3: dec should go to 5', dec(5,calc,0));
                it('4: dec should stay go to 10', dec(10,calc,5));
                it('5: set to 9 should set to 10', set(10,calc, 9));
                it('6: inc should stay 10 ', inc(10,calc,10));
                it('6: set to 999 should set to 10 ', set(10,calc,999));
                it('6: inc should stay on 10 ', inc(10,calc,10));
            });
        });
    ...
    describe('Test 12: Inv= fix, Case = doNothing, Min = fix', ()=>{
        ...
        describe('Test 14: Inv= fix, Case = fix, Min = Fix', ()=>{
            ...
            describe ('CASE 1:inv = 36, min = 36, case = 13, factor = 1', () => {
                let  config: UomItemConfiguration = {'UOMKey': "", 'Case':-2, 'Min': 0, 'Factor':1.5};
                let inventory: number = 6;
                let calc = new QuantityCalculator(config,inventory,caseBehavior,minBehavior,invBehavior);
                describe ('1: combine tests:', () => {
                    it('1: increment should go to -2 ', inc(-2,calc,0));
                    it('1: inc should go to -4', inc(-4,calc,-2));
                    it('1: inc should go to -6', inc(-6,calc,-4));
                });
            });
        });
    });
