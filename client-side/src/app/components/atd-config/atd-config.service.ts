...
export class AtdConfigService {
    ...
    async removeATDAndTSA(atdID: number): Promise<any>{
        return await this.papiClient.addons.api.uuid(this.pluginUUID).file('api').func('remove_tsa_and_atd').post(undefined,{'key': atdID});
    }
}